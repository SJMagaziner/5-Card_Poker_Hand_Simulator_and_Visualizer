...
(dict.get(rank_dictionary, card1_value[2:3]))
(dict.get(suit_dictionary, card1_suit[3:4]))
...
#%% Reverse engineer to place input one's hand
def see_your_hand(a='a',b='b', c='c', d='d', e='e'):
    '''Input your hand using capitalalpha-alpha or numeric-alpha notation.  E.g. The Ace of spades is AS and the 10 of
     hearts is 10S'''
    # This calls the png file associated with each card the player names
    card1_file = a + '.png'
    card2_file = b + '.png'
...
see_your_hand(a='AH', b='AD', c='AC', d='AS', e='KC')
